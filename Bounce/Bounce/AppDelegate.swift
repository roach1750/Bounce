...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var tempPostImageData: Data?
    var tempPostMessage: String?
    ...
    lazy var applicationDocumentsDirectory: URL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "awesomeApps.Core_Data_Tutorial" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "Data Model", withExtension: "momd")!
